						...
						<Toggle>
							{({ on, toggle }) => (
								<Fragment>
									{
										!on
										&& <Modal title="Login"><LoginForm /></Modal>
									}
									<button type="button" className={`dropdown-item btn btn-${themeClass} btn-lg`} onClick={event => this.toggleModal(toggle, event)} aria-haspopup="true" aria-expanded="false">
										Show Modal
									</button>
								</Fragment>
							)}
